...
<section class="ib_banner" style='background: url(https://staging-mypompanodentist-staging.kinsta.cloud/wp-content/uploads/2023/01/background.jpg
...
<!-- Banner Section End -->
<div class=" container  ib_gallery_container">
     <div class="row">
...
<section class="section main--area main--area--margin">
            <div class="container-fluid ">
                <div class="before--txt--area d-none">
                ...
                <div class="row slider__section align-items-center justify-content-center  d-none ">
